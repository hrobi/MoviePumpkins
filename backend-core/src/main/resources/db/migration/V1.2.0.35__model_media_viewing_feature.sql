...
SELECT review_id                                 as review_id,
       SUM(CASE WHEN is_liked THEN 1 ELSE 0 END) as likes,
       SUM(CASE WHEN is_liked THEN 0 ELSE 1 END) as dislikes
FROM review_like
group by review_id;
...
ALTER TABLE review_like
    ...
    ADD CONSTRAINT review_like_review_id_fkey FOREIGN KEY (review_id) REFERENCES review,
