...
val mediaModificationValidation = Validation<MediaModification> {
...
val possibleYearValidation = Validation<Int> {
    minimum(1900)
    maximum(LocalDate.now().year + 100)
}

val movieModificationValidation = Validation<MovieModification> {
...
val seriesModificationValidation = Validation<SeriesModification> {
    run(mediaModificationValidation)
