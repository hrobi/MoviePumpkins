...
import { MainMenu } from "@/features/app.scaffold/components";
import { useMenuAnchor } from "@/features/app/hooks";
import { UserProfileMenu } from "@/features/user-profile/components";
...
export function AppHeader({ user, profile }: AppHeaderParams) {
